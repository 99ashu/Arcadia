...
def spaceInvader():
    ...
    backgroundImage = pygame.image.load("SpaceInvader/assets/bg.jpg")
    ...
    class Game():
        ...
        def __init__(self, player, alienGroup, playerBulletGroup, alienBulletGroup):
            ...
            self.newRoundSound = pygame.mixer.Sound("SpaceInvader/assets/new_round.wav")
            self.newRoundSound.set_volume(0.2)
            self.breachSound = pygame.mixer.Sound("SpaceInvader/assets/breach.wav")
            self.breachSound.set_volume(0.3)
            self.alienHitSound = pygame.mixer.Sound("SpaceInvader/assets/alien_hit.wav")
            self.alienHitSound.set_volume(0.3)
            self.playerHitSound = pygame.mixer.Sound("SpaceInvader/assets/player_hit.wav")
            self.playerHitSound.set_volume(0.2)

            self.font = pygame.font.Font("SpaceInvader/assets/Facon.ttf", 50)
    ...
    class Player(pygame.sprite.Sprite):
        def __init__(self, bulletGroup):
            super().__init__()
            self.image = pygame.image.load("SpaceInvader/assets/player_ship.png")
            ...
            self.shootSound = pygame.mixer.Sound("SpaceInvader/assets/player_fire.wav")
    ...
    class Alien(pygame.sprite.Sprite):
        def __init__(self, x, y, velocity, bulletGroup):
            super().__init__()
            self.image = pygame.image.load("SpaceInvader/assets/alien.png")
            self.rect = self.image.get_rect()
            ...
            self.shootSound = pygame.mixer.Sound("SpaceInvader/assets/alien_fire.wav")
            self.shootSound.set_volume(0.2)
    ...
    class PlayerBullet(pygame.sprite.Sprite):
        def __init__(self, x, y, bulletGroup):
            super().__init__()
            self.image = pygame.image.load("SpaceInvader/assets/green_laser.png")
            self.rect = self.image.get_rect()
            self.rect.centerx = x
            self.rect.centery = y
    ...
    class AlienBullet(pygame.sprite.Sprite):
        def __init__(self, x, y, bulletGroup):
            super().__init__()
            self.image = pygame.image.load("SpaceInvader/assets/red_laser.png")
            self.rect = self.image.get_rect()
            self.rect.centerx = x
            self.rect.centery = y
