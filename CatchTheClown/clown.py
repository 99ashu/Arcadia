...
def catch_the_clown():
    ...
    backgroundImage = pygame.image.load("CatchTheClown/assets/background.png")
    backgroundImageRect = backgroundImage.get_rect()
    backgroundImageRect.topleft = (0,0)
    
    clownImage = pygame.image.load("CatchTheClown/assets/clown.png")
    ...
    titleFont = pygame.font.Font("CatchTheClown/assets/Celosia.otf", 50)
    hudFont = pygame.font.Font("CatchTheClown/assets/Celosia.otf", 40)
    ...
    point = pygame.mixer.Sound("CatchTheClown/assets/SonicRingg.wav")
    point.set_volume(0.7)
    miss = pygame.mixer.Sound("CatchTheClown/assets/Zap.wav")
    miss.set_volume(0.2)
    pygame.mixer.music.load("CatchTheClown/assets/clownbgm.wav")
