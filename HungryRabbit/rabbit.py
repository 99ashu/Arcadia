...
def hungry_rabbit():
    ...
    backgroundImage = pygame.image.load("HungryRabbit/assets/garden.jpg")
    backgroundImageRect = backgroundImage.get_rect()
    backgroundImageRect.bottom = WINDOW_HEIGHT

    rabbitLeftImage = pygame.image.load("HungryRabbit/assets/rabbit_left.png")
    rabbitRightImage = pygame.image.load("HungryRabbit/assets/rabbit_right.png")
    playerImage = rabbitLeftImage
    playerRect = playerImage.get_rect()
    playerRect.centerx = WINDOW_WIDTH//2
    playerRect.bottom = WINDOW_HEIGHT

    carrotImage = pygame.image.load("HungryRabbit/assets/carrot.png")
    ...
    titleFont = pygame.font.Font("HungryRabbit/assets/Shadow.ttf", 70)
    hudFont = pygame.font.Font("HungryRabbit/assets/slum.ttf", 40)
    endFont = pygame.font.Font("HungryRabbit/assets/Celosia.otf", 40)
    welcomeFont = pygame.font.Font("HungryRabbit/assets/regular.ttf", 150)
    ...
    pygame.mixer.music.load("HungryRabbit/assets/bgm.wav")
    point = pygame.mixer.Sound("HungryRabbit/assets/point.wav")
    point.set_volume(0.5)
    miss = pygame.mixer.Sound("HungryRabbit/assets/miss.wav")
    miss.set_volume(0.3)
