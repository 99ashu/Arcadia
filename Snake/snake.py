...
def snake():
    ...
    pygame.mixer.music.load("Snake/assets/backgroundbgm.wav")
    point = pygame.mixer.Sound("Snake/assets/pick.wav")
    point.set_volume(0.3)
    miss = pygame.mixer.Sound("Snake/assets/Zap.wav")
    miss.set_volume(0.3)

    ############################################### FONTS ###########################################################

    Font = pygame.font.Font("Snake/assets/lemon.otf", 70)
    endFont = pygame.font.Font("Snake/assets/lemon.otf", 50)
    welcomeFont = pygame.font.Font("Snake/assets/lemon.otf", 90)
    startFont = pygame.font.Font("Snake/assets/lemon.otf", 45)
