...
def monster():
    ...
    backgroundImage = pygame.image.load("MonsterHunter/assets/background.png")
    backgroundImageRect = backgroundImage.get_rect()
    backgroundImageRect.x = 0
    backgroundImageRect.y = 100

    titleFont1 = pygame.font.Font("MonsterHunter/assets/Abrushow.ttf", 80)
    ...
    titleFont2 = pygame.font.Font("MonsterHunter/assets/Abrushow2.otf", 50)
    ...
    class Game():
        ...
        def __init__(self, player, monsterGroup):
            ...
            self.nextLevelSound = pygame.mixer.Sound("MonsterHunter/assets/next_level.wav")
            self.nextLevelSound.set_volume(0.2)

            self.font = pygame.font.Font("MonsterHunter/assets/Celosia.otf", 28)

            blueImage = pygame.image.load("MonsterHunter/assets/blue_monster.png")
            greenImage = pygame.image.load("MonsterHunter/assets/green_monster.png")
            purpleImage = pygame.image.load("MonsterHunter/assets/purple_monster.png")
            yellowImage = pygame.image.load("MonsterHunter/assets/yellow_monster.png")
    ...
    class Player(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.image = pygame.image.load("MonsterHunter/assets/knight.png")
            ...
            self.catchSound = pygame.mixer.Sound("MonsterHunter/assets/catch.wav")
            self.catchSound.set_volume(0.1)
            self.dieSound = pygame.mixer.Sound("MonsterHunter/assets/die.wav")
            self.dieSound.set_volume(0.2)
            self.warpSound = pygame.mixer.Sound("MonsterHunter/assets/warp.wav")
